        ...
        <div class="row">
            @php
                if($caixa == null){
                    ...
                    echo \Bootstrapper\Facades\Button::normal('<img src="https://cdn-icons-png.flaticon.com/512/1146/1146617.png" width="45px" >   Valor de Abertura: '.$caixa->getValorAberturaFormatado())->large()->withAttributes(['disabled' => 'true', 'style'=>'width: 700px; height:70px']).'<br><br>';
                    ...
                    echo \Bootstrapper\Facades\Button::INFO('<img src="https://cdn-icons-png.flaticon.com/512/2174/2174475.png" width="45px" >  Dinheiro: '.\App\Http\Controllers\CashMovesController::buscaValoresDinheiro($caixa->id))->withAttributes(['data-toggle' => 'modal', 'data-target' => '#caixaDinheiro', 'style'=>'width: 230px; height:70px']).'<br><br>';
